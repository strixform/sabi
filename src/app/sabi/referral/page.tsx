      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="text-center pt-4 pb-2">
          ...
          <p className="text-slate-400 text-sm mt-2 max-w-sm mx-auto">
            Invite friends to SABI. When they fund their wallet with <span className="text-white font-semibold">₦200</span> or more, you both earn <span className="text-white font-semibold">₦100</span> — <span className="text-white font-semibold">no limit</span> on how many.
          </p>
        </div>
        ...
        <div className="bg-[#0F1420] border border-white/[0.06] rounded-2xl p-5">
          ...
          <div className="space-y-3">
            {[
              ...
              { step: '3', text: 'They fund their wallet with ₦200 or more', color: 'text-pink-400 bg-pink-500/10' },
