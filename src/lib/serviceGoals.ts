...
export const SERVICE_GOALS: ServiceGoal[] = [
  ...
  { id: 'app', label: 'App Growth', emoji: '📲', tagline: 'Rank higher, get installs',
    ...
    match: /install/i },
  { id: 'traffic', label: 'Traffic & Conversions', emoji: '🌐', tagline: 'Turn clicks into customers',
    helper: 'Send real Nigerian visitors to your website, landing page or bio link — and get real add-to-cart, RSVP and sign-up actions — so more eyes become real customers. Great for launches, promos, stores and events.',
