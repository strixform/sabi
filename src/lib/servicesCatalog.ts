...
**TIP:** Post your Status as usual right after ordering — your new contacts will start seeing it immediately, and every future Status too. Your number is never shown publicly.`,
    ...
    action: 'Contacts',
    pricePerUnit: 2000, // ₦10 per contact saved
    minQuantity: 50,
    maxQuantity: 5000,
    speed: 'medium',
    refillable: false,
...
**HOW IT WORKS:** Paste your post/Reel link and choose how many of the top comments to like. That many of the earliest comments each get a real like.`,
    ...
    pricePerUnit: 2000, // ₦10 per comment liked
    minQuantity: 10,
    maxQuantity: 1000,
    speed: 'fast',
    refillable: false,
...
**HOW IT WORKS:** Paste your tweet link and choose how many top replies to like.`,
    ...
    action: 'Post Comment Likes',
    pricePerUnit: 2000, // ₦10 per reply liked
    minQuantity: 10,
    maxQuantity: 1000,
    speed: 'fast',
    refillable: false,
...
**WHY IT MATTERS:** Bot plays get wiped and can flag your account. Real paid listeners create genuine momentum the algorithm trusts — and some become actual fans.`,
    category: PLATFORMS.AUDIOMACK, action: 'Plays', pricePerUnit: 2000, minQuantity: 100, maxQuantity: 100000, speed: 'medium', refillable: false,
  },
  {
  ...
  // ============ BOOMPLAY (artistes) ============
  {
    ...
    category: PLATFORMS.BOOMPLAY, action: 'Plays', pricePerUnit: 2000, minQuantity: 100, maxQuantity: 100000, speed: 'medium', refillable: false,
  },
  {
  ...
  // ============ APPLE MUSIC + SHAZAM (artistes) ============
  {
    ...
    category: PLATFORMS.APPLE_MUSIC, action: 'Plays', pricePerUnit: 2000, minQuantity: 100, maxQuantity: 100000, speed: 'medium', refillable: false,
  },
  {
...
**WHY IT MATTERS:** TikTok pushes sounds that real people use. One wave of creators using your sound can trigger an organic trend money can't otherwise buy.`,
    category: PLATFORMS.TIKTOK, action: 'Sound Use', pricePerUnit: 1000000, minQuantity: 10, maxQuantity: 5000, speed: 'slow', refillable: false,
  },
  {
    ...
    category: PLATFORMS.TIKTOK, action: 'UGC Video', pricePerUnit: 1000000, minQuantity: 10, maxQuantity: 2000, speed: 'slow', refillable: false,
  },
